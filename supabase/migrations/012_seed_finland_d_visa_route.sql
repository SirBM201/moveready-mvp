...
-- Finland D visa route enrichment.
-- Run after 001 through 011 migrations.
...
union all select id, 'Family-ties documents', 'conditional', 'family_member', 'Spouse and child applications require route-specific family evidence and linking instructions.', 60 from version;
