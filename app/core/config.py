...
PASSPORT_INDEX_PROVIDER_ENABLED = env_bool("PASSPORT_INDEX_PROVIDER_ENABLED", False)
PASSPORT_INDEX_PROVIDER_NAME = env("PASSPORT_INDEX_PROVIDER_NAME", "MoveReady starter cache")
PASSPORT_INDEX_PROVIDER_URL = env("PASSPORT_INDEX_PROVIDER_URL")
PASSPORT_INDEX_PROVIDER_KEY = env("PASSPORT_INDEX_PROVIDER_KEY")
PASSPORT_INDEX_PROVIDER_METHOD = env("PASSPORT_INDEX_PROVIDER_METHOD", "GET").upper()
PASSPORT_INDEX_PROVIDER_AUTH_HEADER = env("PASSPORT_INDEX_PROVIDER_AUTH_HEADER", "X-API-Key")
PASSPORT_INDEX_PROVIDER_HOST_HEADER = env("PASSPORT_INDEX_PROVIDER_HOST_HEADER")
PASSPORT_INDEX_PROVIDER_EXTRA_HEADERS_JSON = env("PASSPORT_INDEX_PROVIDER_EXTRA_HEADERS_JSON", "{}")
PASSPORT_INDEX_PROVIDER_COUNTRY_CODE_FORMAT = env("PASSPORT_INDEX_PROVIDER_COUNTRY_CODE_FORMAT", "alpha2").lower()
