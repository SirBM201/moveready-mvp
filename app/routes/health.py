...
def _expected_endpoints() -> List[str]:
    p=config.API_PREFIX
    return [f"{p}/auth/health",f"{p}/account/summary",f"{p}/account/preferences",f"{p}/account/sessions",f"{p}/account/activity",f"{p}/account/action-center",f"{p}/account/outcomes",f"{p}/account/data-export",f"{p}/account/privacy-requests",f"{p}/operations/status",f"{p}/platform/modules",f"{p}/source-health/summary",f"{p}/opportunity-finder/recommendations",f"{p}/financial-readiness/check",f"{p}/route-comparison",f"{p}/evidence/options",f"{p}/evidence/documents",f"{p}/evidence/packs",f"{p}/evidence/packs/generate",f"{p}/evidence/refusal-repair",f"{p}/applications/options",f"{p}/applications",f"{p}/applications/alerts",f"{p}/jobs/options",f"{p}/jobs/profile",f"{p}/jobs/profile/bootstrap",f"{p}/jobs/summary",f"{p}/jobs/companies",f"{p}/jobs/recruiters",f"{p}/jobs",f"{p}/jobs/applications",f"{p}/jobs/resume-vault",f"{p}/jobs/automation/overview",f"{p}/jobs/automation/watches/bootstrap",f"{p}/jobs/automation/scan",f"{p}/language-coach/profile",f"{p}/billing/status",f"{p}/handoffs",f"{p}/handoffs/support-cases",f"{p}/journey/options",f"{p}/journey/settlement-plan",f"{p}/visa-power/provider/status",f"{p}/visa-power/provider/schedule/status",f"{p}/visa-power/passport-index/check",f"{p}/visa-power/check",f"{p}/admin/operations/status",f"{p}/admin/source-governance/queue",f"{p}/admin/review-queue",f"{p}/admin/application-cases",f"{p}/admin/application-case-alerts",f"{p}/admin/application-cases/alerts/scan",f"{p}/admin/jobs/automation/scheduled-scan",f"{p}/admin/privacy-requests"]
