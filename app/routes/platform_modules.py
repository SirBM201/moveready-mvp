...
PLATFORM_MODULES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "current_support": "Users can save watchlist preferences now. Message delivery is enabled only after the selected notification provider and opt-in flow are approved.",
    },
    {
        "slug": "visa-power",
        ...
        "current_support": "The Visa Power API and frontend preview are live with source-reviewed starter records for Mexico, Dominican Republic, Panama, and Costa Rica.",
    },
    {
        "slug": "documents",
