...
def create_app() -> Flask:
    ...
    from app.routes import admin, health, opportunities, partners, platform_modules, profiles, readiness_tools, relocation_public, reports, saved_routes, timeline, watchlist
